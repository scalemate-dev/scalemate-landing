...
import styles from "./ROICalculatorV2.module.scss"
...
export default function ROICalculatorV2() {
  ...
  const noAutomation = (() => {
    ...
    const money =
      ...
      UAM_HOUR_PRICE * time
    return { time, money: Math.round(money) }
  })()
      ...
      <Container>
        <header className={styles.header}>
          ...
          <h2 className={styles.title}>
            ...
            <em className={styles.titleAccent}>with automation.</em>
          </h2>
          <p className={styles.subtitle}>
            Let's measure your user acquisition performance before you hop in.
            Estimate time and money savings after you automate your ad
            campaigns.
          </p>
        </header>
