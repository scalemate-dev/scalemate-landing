...
const UploaderWidget = () => {
  ...
  const isConnected =
    ...
    (connectedPlatform === "facebook" && isFacebookConnected && adAccounts.length > 0)
  ...
  return (
    <div className={styles.widget}>
      ...
      <div className={styles.header}>
        <h2>Creative Uploader</h2>
        <p>Select files from Google Drive and upload them to your ad accounts.</p>
      </div>
      ...
      <div className={styles.content}>
        ...
        <div className={styles.filesSection}>
          <div className={styles.sectionHeader}>
            <div className={cn(styles.stepBadge, { [styles.completed]: hasFiles })}>
          ...
          >
            ...
            <span className={styles.dropzoneText}>
              {hasFiles ? `${pickerFiles.length} files selected` : "Browse Google Drive"}
            </span>
            <span className={styles.dropzoneHint}>Accepted formats: jpg, png, mp4</span>
          </button>
          ...
          {hasFiles && (
            <div className={styles.fileList}>
              <div className={styles.fileListHeader}>
                <span className={styles.fileCount}>{pickerFiles.length} files selected</span>
              ...
              <div className={styles.files}>
                {pickerFiles.map((file, index) => (
                  <div key={index} className={styles.fileItem}>
                    <div className={cn(styles.fileIcon, getFileIconClass(file))}>
                      {getFileIcon(file)}
                    </div>
        ...
        <div className={styles.divider}>
          <div className={cn(styles.arrowCircle, { [styles.ready]: canUpload })}>
        ...
        <div className={styles.destinationsSection}>
          <div className={styles.sectionHeader}>
            <div className={cn(styles.stepBadge, { [styles.completed]: hasSelectedAccount })}>
