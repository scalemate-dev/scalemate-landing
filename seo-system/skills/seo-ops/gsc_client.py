...
_default_creds = os.path.join(os.path.dirname(__file__), "client_secret.json")
GOOGLE_CREDENTIALS_FILE = os.environ.get("GOOGLE_CREDENTIALS_FILE", _default_creds if os.path.exists(_default_creds) else "")
