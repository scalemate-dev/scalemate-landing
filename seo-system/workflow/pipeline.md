...
- **facebook-ads-automation-listicle-rework** — discovery completed 2026-05-07 (S5' rework, local on `main`). Brief: [`seo-system/topics/facebook-ads-automation-listicle-rework/brief.md`](../topics/facebook-ads-automation-listicle-rework/brief.md). Primary keyword `facebook ads automation` (vol 150 KD 6 CPC $4.50 TP 900); cluster ~250 vol/mo across 8 on-topic non-branded keywords (Ahrefs 2026-05-07). SERP analysis confirms listicle format wins: primary SERP has adstellar listicle at #7 (DR 46) co-existing with Meta-owned + vendor landings; listicle-variant SERP `best facebook ads automation tools 2026` is 7/9 listicles on DR 30-50 sites with AI Overview present. Existing `/blog/facebook-ads-automation` is the rework target — same URL preserved (deployed 2026-04-07, 0 GSC impressions over 90d, NOT indexed at T+4wk). Pain validated: 5+ active r/FacebookAds + r/PPC threads (10-50+ comments each) on manual ad-management drudgery, "burning 4-6 hours a week", "lost 5 hours" to no-rollback rules. Unique angle: operator-written 12-tool listicle from team running Meta + TikTok at 2M+ ads launched, with free-tier path + spend-tier decision framework + rules-with-rollback as differentiation column. Listicle structure proposed: 12 tools (Native Meta / Scalemate / Birch / Madgicx / Smartly / Kitchn / AdEspresso / Trapica / AdManage / Make.com / Adzooma / creative-automation honest-mention) with 8-column comparison table + decision-framework block. 6 inputs needed from Natalia listed in brief (peer-set confirm, pricing verification, first-hand operator anecdote, title selection, internal-link plan).
