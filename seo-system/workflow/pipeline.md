...
- **facebook-ads-automation-listicle-rework** — brief approved by Natalia 2026-05-08, local on `main`. Brief: [`seo-system/topics/facebook-ads-automation-listicle-rework/brief.md`](../topics/facebook-ads-automation-listicle-rework/brief.md). Tools research: [`seo-system/topics/facebook-ads-automation-listicle-rework/tools-research.md`](../topics/facebook-ads-automation-listicle-rework/tools-research.md). New URL: `/blog/best-facebook-ads-automation-tools` (CREATE NEW; old `/blog/facebook-ads-automation` stays AS-IS). Slate locked at 12: Scalemate (1) · Meta Native (2) · Birch (3) · Madgicx (4) · Smartly (5) · AdEspresso (6) · Trapica (7) · AdNova (8) · Kitchn (9) · AdManage (10) · Make.com/n8n/Zapier lateral group (11) · Hunch/Pencil/AdCreative.ai lateral group (12). **Hybrid editorial depth:** deep narrative on 6 (Scalemate, Meta Native, Birch, Madgicx, AdNova, AdManage) + table-only on 4 (Smartly, AdEspresso, Trapica, Kitchn) + lateral group paragraphs on 11 + 12. **Primary frame:** Angles F + G paired (workflow-chains for ad ops + operator-playbooks-included), JTBD voice. **Self-#1 honesty framing** mandatory in intro (own the conflict explicitly per Natalia 2026-05-08). Target ~3,500 words. Coordinated release with `/automation-rules-library` (S9'). Title: "12 Best Facebook Ads Automation Tools for 2026 (Meta + TikTok)" (60 chars, recommended primary).
