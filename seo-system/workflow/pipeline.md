...
- **facebook-ads-automation-listicle-rework** — discovery started 2026-05-07. S5' replacement for killed `facebook-ads-automation-tools-comparison` (§9). Rework of existing `/blog/facebook-ads-automation` (§8 Published) → listicle format ("12 Best Facebook Ads Automation Tools 2026"). Same URL preserves equity. Cluster: `facebook ads automation` (150 KD 6) + `…tools` (50 KD 14) + `…software` (40 KD 12). SERP analysis confirms listicle wins. Discovery brief: `seo-system/topics/facebook-ads-automation-listicle-rework/brief.md` (skeleton). Full S5' notes: `action-lists/2026-05-04.md` S5'.
